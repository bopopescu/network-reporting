import ad_network_reports.query_managers as query_managers
...
AD_NETWORKS = {'admob' : AdNetwork(constructor = AdMobScraper, get_pub_id =
                         query_managers.get_pub_id),
               'jumptap' : AdNetwork(constructor = JumpTapScraper,
                           get_pub_id = query_managers.get_pub_id_from_name),
               'iad' : AdNetwork(constructor = IAdScraper, get_pub_id =
                       query_managers.get_pub_id),
               'inmobi' : AdNetwork(constructor = InMobiScraper,
                          get_pub_id = query_managers.get_pub_id),
               'mobfox' : AdNetwork(constructor = MobFoxScraper, get_pub_id =
                          query_managers.get_pub_id)}
