...
def threadproc():
    ...
    while not quitevent.is_set():
        try:
            ...
            url = "http://36-staging.latest.mopub-inc.appspot.com/m/ad?v=1&f=300x250&udid=7BC22E8C-99A9-50C4-B60F-DFC07EC6BACC%d&q=coffee&id=agltb3B1Yi1pbmNyDAsSBFNpdGUYkaoMDA&w=0.000000&h=0.000000"%random.randint(0,10)
