...
def jumptap_scraper(network_credential, from_date, to_date):
    some_dict ={"user": network_credential.username, "pass": network_credential.password, "fromDate": from_date, "toDate": to_date, "groupBy": "spot"}#,"sites": network_credential.app_name}
