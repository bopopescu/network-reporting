        ...
        for login_info in get_login_credentials():
            ...
            try:
                ...
                logging.error(("Couldn't get get stats for %s network for"
                        ...
                        (login_info.ad_network_name, login_info.account.title,
            ...
            for stats in stats_list:
                ...
                # Using GQL to get the ad_network_app_mapper object that
                # corresponds to the login_info and stats
