...
(function($, Backbone, _){
    ...
    var DashboardController = {
        initializeDashboard: function(bootstrapping_data) {
            ...
            // When we do comparisons, we need to know whether we're comparing
            // ad sources or individual campaigns (and in the future, individual
            // adgroups and creatives). This function figures that out.
            function get_advertiser_type() {
                ...
                // if any individual campaigns have been checked, 
                // they're comparing campaigns.
                var use_source = true;
            ...
            // Same deal as with `get_advertiser_type`, but for apps and adunits
            function get_publisher_type() {
                ...
                // if any individual adunits have been checked, 
                // they're comparing adunits.
                var use_app = true;
            ...
            // Generates a query from what's been selected in the
            // advertiser table.
