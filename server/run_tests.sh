...
then
    ...
    # nosetests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --where='./userstore/tests'
    # # nosetests ./userstore/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./'
    # 
    # 
    # nosetests ./reporting/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox 
    # nosetests ./budget/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # nosetests ./account/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # nosetests ./common/utils/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # 
    # # Adserver Tests
    # nosetests ./ad_server/optimizer/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # nosetests ./ad_server/filters/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox 
    # nosetests ./ad_server/auction/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # nosetests ./ad_server/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # nosetests ./ad_server/parser/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # nosetests ./ad_server/renderers/tests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox   
    # nosetests ./ad_server/neworks/tests  --with-xunit --gae-lib-root="$1"--match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    #   
    # # System T --with-xunit --gae-lib-root="$1" ests (Must live in server root dir for some reason TODO: Fix this)
    # nosetests system_mptests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # nosetests network_config_mptests  --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
    # 
    echo "mopub logging tests"
    nosetests ./stats/tests --with-xunit --gae-lib-root="$1" --match='(?:^|[\b_\./-])mptest' --with-gae --gae-application='./' --without-sandbox
fi
