...
class NetworkIndexHandler(RequestHandler):
    def get(self):
        ...
        # Get all adgroups.
        all_adgroups = AdvertiserQueryManager.get_adgroups_dict_for_account(self.account).values()
        ...
        network_adgroups = filter(lambda a: a.campaign.campaign_type in ['network'], all_adgroups)
