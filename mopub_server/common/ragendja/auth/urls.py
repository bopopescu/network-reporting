...
if 'common.ragendja.auth.middleware.GoogleAuthenticationMiddleware' in \
        settings.MIDDLEWARE_CLASSES:
    urlpatterns += patterns('',
        url(LOGIN, 'common.ragendja.auth.views.google_login',
            name='django.contrib.auth.views.login'),
        url(LOGOUT, 'common.ragendja.auth.views.google_logout', LOGOUT_DATA,
            name='django.contrib.auth.views.logout'),
    )
elif 'common.ragendja.auth.middleware.HybridAuthenticationMiddleware' in \
        settings.MIDDLEWARE_CLASSES:
    urlpatterns += patterns('',
        url(LOGIN, 'common.ragendja.auth.views.hybrid_login',
            name='django.contrib.auth.views.login'),
        url(LOGOUT, 'common.ragendja.auth.views.hybrid_logout', LOGOUT_DATA,
            name='django.contrib.auth.views.logout'),
    )
