...
then
    ...
    nosetests --gae-datastore='./test_data/basic_test.datastore' --with-gae --gae-application='./' ad_server_tests # --with-coverage
else
    ...
    nosetests --with-coverage --with-xunit --gae-lib-root="$1"  --gae-datastore='./test_data/basic_test.datastore' --with-gae --gae-application='./' ad_server_tests # --with-coverage
fi
