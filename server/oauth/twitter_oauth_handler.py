...
OAUTH_APP_SETTINGS = {
    ...
    'twitter': {
        ...
        'consumer_key': 'FL4njXvBRVhxzuRoULRAA',
        'consumer_secret': 'KKWTktSNNIYOPzWgOI0hjkLpU5m4hQKzTjY5efYYU0',
    ...
    'google': {
        ...
        'consumer_key': 'www.gethighnote.com',
        'consumer_secret': 'i7OSa0p9JwdGgH08Q2cdQ1UT',
...
class OAuthClient(object):
    ...
    def callback(self, return_to='/pages/callback'):
