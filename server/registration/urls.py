...
from registration import auth_views
...
urlpatterns = patterns('registration.views',
                       ...
                       #     auth_views.logout,
                       #     name='auth_logout'),
                       url(r'^settings/change/success/$',
                           'settings_change_success',
                           name='settings_change_success'),
                       url(r'^settings/change/$',
                           'settings_change',
                       ...
                       url(r'^migrate/$',
                           auth_views.migrate_user,
                           name='registration_migrate_user'),       
                       url(r'^migrate/complete/$',
                           auth_views.migrate_user_complete,
                           name='registration_migrate_user_complete'),       
                       url(r'^register/$',
                           'register',
                           name='registration_register'),
                       url(r'^register/google/$',
                           'register_google',
                           name='registration_register_google'),
                       url(r'^register/complete/$',
                           direct_to_template,
                           {'template': 'registration/registration_complete.html'},
                           name='registration_complete'),
                       url(r'^register/google/complete/$',
                           direct_to_template,
                           {'template': 'registration/registration_google_complete.html'},
                           name='registration_google_complete'),                           
                       )
