...
def offline_rollup_mptest():    
    ...
    assert_true(stats_updater.update_model(adunit_id1, creative_id1, [100, 90, 80, 70], date_hour=hour1))
    assert_true(stats_updater.update_model(adunit_id1, creative_id2, [100, 90, 80, 70], date_hour=hour1))
    assert_true(stats_updater.update_model(adunit_id2, creative_id1, [100, 90, 80, 70], date_hour=hour1))
    ...
    assert_true(stats_updater.update_model(adunit_id2, creative_id1, a2_c1_hour2, date_hour=hour2))
